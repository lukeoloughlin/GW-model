...
namespace GW {
    ...
    private:
        ...
        void initialise_Jxfer(){ Jxfer = parameters.rxfer * (CRUs.CaSS - globals.Cai); }
        void initialise_Jtr(){ Jtr = parameters.rtr * (globals.CaNSR - CRUs.CaJSR); }
        void initialise_QKr(){ QKr(1,2) = parameters.Kf; QKr(2,1) = parameters.Kb; }
        ...
        void update_CRUstate_from_temp(const CRUStateThread<FloatType> &temp, const int i);
