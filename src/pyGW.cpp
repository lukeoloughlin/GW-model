...
PYBIND11_MODULE(GreensteinWinslow, m) {
    ...
    *****************/
    ...
    py::class_<PyParametersLattice<double>>(m, "GWLatticeParameters")
        ...
        .def_readwrite("rcyto", &PyParametersLattice<double>::rcyto, "Intersubspace calcium transfer rate")
        .def_readwrite("rnsr", &PyParametersLattice<double>::rnsr, "Intersubspace calcium transfer rate")
